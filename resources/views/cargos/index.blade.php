...
<div class="card mb-4">
    <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
        <div><i class="fas fa-briefcase me-2"></i>Listado de cargos</div>
        <a class="btn btn-sm btn-primary" href="{{ route('cargos.create') }}">
            <i class="fas fa-plus me-1"></i>Nuevo
        </a>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-sm table-striped table-hover w-100" id="tabla-cargos">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Descripción</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $cargo->afiliados_count }}</td>
                        <td class="text-end text-nowrap">
                            <a class="btn btn-sm btn-warning" data-bs-toggle="tooltip" title="Editar"
                               href="{{ route('cargos.edit', $cargo) }}"><i class="fas fa-edit"></i></a>
                            <form action="{{ route('cargos.destroy', $cargo) }}" method="POST" class="d-inline"
                                  data-confirm="¿Realmente desea eliminar este cargo?">
                                @csrf
                                @method('DELETE')
